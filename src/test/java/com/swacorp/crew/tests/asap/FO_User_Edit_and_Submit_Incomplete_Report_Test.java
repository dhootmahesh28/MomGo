...
public class FO_User_Edit_and_Submit_Incomplete_Report_Test extends TestManager {
    ...
    FO_User_Edit_and_Submit_Incomplete_Report_Test(){
    ...
    public void TC0190696_Validate_FO_user_is_able_Edit_and_Submit_In_complete_report(String[] testData) throws Exception{
        setScenarioName("TC0190696_Validate FO_user is able Edit and Submit In complete report");
        try {
