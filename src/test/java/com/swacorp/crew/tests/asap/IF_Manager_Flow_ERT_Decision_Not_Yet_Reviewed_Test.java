...
public class IF_Manager_Flow_ERT_Decision_Not_Yet_Reviewed_Test extends TestManager {
    ...
    IF_Manager_Flow_ERT_Decision_Not_Yet_Reviewed_Test(){
    ...
    @Test(groups = {"IFDEMO"}, dataProvider = "IF_ASAP_REPORT", dataProviderClass = ASAPTestDataProvider.class)
    public void TC0190730_ASAP_Report_IF_Manager_Flow_ERT_Decision_Not_yet_reviewed_and_Additional_info_required(String[] testData) throws Exception{
        setScenarioName("TC0190730_ASAP Report-IF Manager-Flow ERT Decision-Not yet reviewed and Additional info required");
        try {
            ...
            swaLifeManagerReport.changeTheStatusOfTheSubmittedReport(swaLifeASAPReport.getStrTrackingNumber(), "POST_ERC", "Not yet reviewed");
            swaLifeManagerReport.changeTheStatusOfTheSubmittedReport(swaLifeASAPReport.getStrTrackingNumber(), "POST_ERC", "Additional information required");
            ...
            swaLifeManagerReport.searchAndCheckTheStatusOfTheReport("", "ERC requires additional information");
