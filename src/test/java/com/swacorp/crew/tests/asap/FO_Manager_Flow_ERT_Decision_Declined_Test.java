...
public class FO_Manager_Flow_ERT_Decision_Declined_Test extends TestManager {
    ...
    FO_Manager_Flow_ERT_Decision_Declined_Test(){
    ...
    public void TC0190713_ASAP_Report_FO_Manager_Flow_ERT_Decision_Declined(String[] testData) throws Exception{
        setScenarioName("TC0190713_ASAP Report-FO Manager-Flow ERT Decision-Declined");
        try {
            ...
            swaLifeManagerReport.changeTheStatusOfTheSubmittedReport(swaLifeASAPReport.getStrTrackingNumber(), "POST_ERT", "Declined");
            swaLifeManagerReport.navigateToERTTab("POST_ERT");
            swaLifeManagerReport.searchAndCheckTheStatusOfTheReport("", "Declined");
