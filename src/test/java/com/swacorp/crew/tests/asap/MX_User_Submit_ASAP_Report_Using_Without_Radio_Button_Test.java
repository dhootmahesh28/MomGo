...
public class MX_User_Submit_ASAP_Report_Using_Without_Radio_Button_Test extends TestManager {
    ...
    MX_User_Submit_ASAP_Report_Using_Without_Radio_Button_Test(){
    ...
    public void TC0190737_Validate_MX_user_is_able_to_create_and_submit_report_without_selecting_immediate_airworthiness_concern_radio_button(String[] testData) throws Exception{
        setScenarioName("TC0190737_Validate MX user is able to create and submit report without selecting immediate airworthiness concern radio buttons");
        try {
