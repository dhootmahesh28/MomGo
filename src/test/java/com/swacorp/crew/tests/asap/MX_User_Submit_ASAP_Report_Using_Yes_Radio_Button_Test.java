...
public class MX_User_Submit_ASAP_Report_Using_Yes_Radio_Button_Test extends TestManager {
    ...
    MX_User_Submit_ASAP_Report_Using_Yes_Radio_Button_Test(){
    ...
    public void TC0190735_Validate_MX_user_is_able_to_create_and_submit_report_by_selecting_immediate_airworthiness_concern_YES_radio_button(String[] testData) throws Exception{
        setScenarioName("TC0190735_Validate MX user is able to create and submit report by selecting immediate airworthiness concern YES radio button");
        try {
