...
public class IF_User_Submit_ASAP_Report_Using_Flight_Hyperlink_Test extends TestManager {
    ...
    IF_User_Submit_ASAP_Report_Using_Flight_Hyperlink_Test(){
    ...
    public void TC0190716_Validate_IF_user_is_able_to_create_and_submit_report_by_clicking_on_Flight_number_hyper_link(String[] testData) throws Exception{
        setScenarioName("TC0190716_Validate IF user is able to create and submit report by clicking on Flight number hyper link");
        try {
