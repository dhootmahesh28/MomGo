...
public class DP_User_Create_And_Submit_Report_With_Flight_Specific_No_Test extends TestManager {
    ...
    DP_User_Create_And_Submit_Report_With_Flight_Specific_No_Test(){
    ...
    public void TC0190666_DP_USER_CreateAndSubmit_Report_Selecting_FlightSpecificYes(String[] testData) throws Exception{
        setScenarioName("TC0190666_Validate DP user is able to create and submit report by selecting flight specific No radio button");
        try {

            swaLifeLogin.loginASAPDPUser();

            swaLifeDPASAPReport.setStrIsFlightSpecific("No");
