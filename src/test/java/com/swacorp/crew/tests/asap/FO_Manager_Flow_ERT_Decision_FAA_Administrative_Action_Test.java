...
public class FO_Manager_Flow_ERT_Decision_FAA_Administrative_Action_Test extends TestManager {
    ...
    FO_Manager_Flow_ERT_Decision_FAA_Administrative_Action_Test(){
    ...
    public void TC0190712_ASAP_Report_FO_Manager_Flow_ERT_Decision_FAA_Administrative_action(String[] testData) throws Exception{
        setScenarioName("TC0190712_ASAP Report-FO Manager-Flow ERT Decision-FAA Administrative action");
        try {
            ...
            swaLifeManagerReport.changeTheStatusOfTheSubmittedReport(swaLifeASAPReport.getStrTrackingNumber(), "POST_ERT", "FAA administrative action");
            swaLifeManagerReport.navigateToERTTab("POST_ERT");
            swaLifeManagerReport.searchAndCheckTheStatusOfTheReport("", "FAA Administrative Action");
