...
public class TC12346 extends TestManager {
    ...
    @Test(groups = {"12345"}, dataProvider = "TC12346", dataProviderClass = FSSRTestDataProvider.class)
    public void TC12346_Crew_Submit_Hazmat_Report_Home_Menu(String[] testData) throws Exception{
        setScenarioName("TC012346_Crew Submit Hazmat Report from Home Menu");
        try {
            fssrLogin.loginFSSR();
